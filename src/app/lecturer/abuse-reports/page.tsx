...
import { getAbuseReportsByLecturer, updateAbuseReportStatus, type AbuseReport } from '@/services/abuseReportsService';
...
export default function LecturerAbuseReportsPage() {
    const { user } = useRole();
    ...
    const fetchReports = async () => {
        ...
        setIsLoading(true);
        try {
            const allReports = await getAbuseReportsByLecturer(user.uid);
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle className="font-headline">Abuse & Harassment Reports</CardTitle>
                <CardDescription>Review and manage confidential reports submitted by your assigned students. Please handle with care and urgency.</CardDescription>
            </CardHeader>
            <CardContent>
