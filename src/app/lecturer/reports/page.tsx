...
export default function LecturerReportsPage() {
    ...
    const fetchReports = async () => {
        ...
        setIsLoading(true);
        try {
            const reportsData = await getReportsByLecturer(user.uid);
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Review daily reports submitted by your students. Provide feedback and approve or reject them.</CardDescription>
            </CardHeader>
            <CardContent>
                {reports.length > 0 ? (
